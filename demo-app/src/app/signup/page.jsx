        ...
        <div className="py-5">
          ...
          <form action="#!" className="mt-5" onSubmit={doSignup}>
            ...
            <div className="mt-3">
              ...
              <input
                type="text"
                className="w-full p-3 text-white rounded-2xl0 bg-gray-800 focus:ring-gray-400-100 border border-gray-800"
            ...
            <div className="mt-3">
              ...
              <input
                type="email"
                className="w-full  text-white  p-3 rounded-2xl bg-gray-800 focus:ring-gray-400-100 border border-gray-800"
                placeholder="Enter here"
                id="user_email"
                name="user_email"
                onChange={(event) => {
